...
use re_log_types::{EntityPath, SetStoreInfo, StoreId, StoreInfo, TimeInt, Timeline};
...
impl ChunkStore {
    // TODO
    // TODO: can this avoid anyhow?
    // TODO: this has to be multithreaded (offload the decoding to a background thread as usual)
